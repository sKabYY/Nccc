...
namespace Nccc
{
    public class Locale
    {
        ...
        {
            if (_TryGetFromLocales(_locales, s, out var text))
            {
                return text;
            }
            if (_TryGetFromLocales(globalLocales, s, out text))
            {
                return text;
            }
            return s;
        ...
        private bool _TryGetFromLocales(IDictionary<string, IDictionary<string, string>> locales, string s, out string content)
        {
